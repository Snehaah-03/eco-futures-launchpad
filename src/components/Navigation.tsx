...
const Navigation = () => {
  ...
  return (
    <header className="flex justify-between items-center p-6 bg-eco-mint shadow-sm sticky top-0 z-10">
      ...
      <nav className="hidden md:flex space-x-6 text-sm">
        ...
        <a href="#product" className="hover:text-eco-forest transition-colors">Our Product</a>
      ...
      {/* Mobile navigation */}
      {isMenuOpen && (
        <div className="absolute top-full left-0 right-0 bg-eco-mint shadow-md md:hidden py-4">
          <nav className="flex flex-col items-center space-y-4 text-sm">
            ...
            <a href="#product" className="hover:text-eco-forest transition-colors" onClick={toggleMenu}>Our Product</a>
